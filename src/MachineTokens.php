...
class MachineTokens
{
     ...
     *
     * @param  ?Operations\CreateMachineTokenRequestBody  $request
     * @return Operations\CreateMachineTokenResponse
     * @throws \Clerk\Backend\Models\Errors\SDKException
     */
    public function create(?Operations\CreateMachineTokenRequestBody $request = null, ?Options $options = null): Operations\CreateMachineTokenResponse
    {
        $retryConfig = null;
        if ($options) {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/machine_tokens');
        $urlOverride = null;
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'CreateMachineToken', [], $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Clerk\Backend\Models\Components\MachineToken', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new Operations\CreateMachineTokenResponse(
