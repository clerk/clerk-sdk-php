...
class EnterpriseConnections
{
     ...
     *
     * @param  ?\Clerk\Backend\Models\Operations\CreateEnterpriseConnectionRequestBody  $request
     * @return \Clerk\Backend\Models\Operations\CreateEnterpriseConnectionResponse
    ...
    public function create(?Operations\CreateEnterpriseConnectionRequestBody $request = null, ?Options $options = null): Operations\CreateEnterpriseConnectionResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['201'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Clerk\Backend\Models\Components\EnterpriseConnection', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     * @return \Clerk\Backend\Models\Operations\CreateEnterpriseConnectionTestRunResponse
     * @throws \Clerk\Backend\Models\Errors\SDKException
     */
    public function createTestRun(string $enterpriseConnectionId, ?Options $options = null): Operations\CreateEnterpriseConnectionTestRunResponse
    {
        $retryConfig = null;
        if ($options) {
            $retryConfig = $options->retryConfig;
        ...
        $request = new Operations\CreateEnterpriseConnectionTestRunRequest(
            enterpriseConnectionId: $enterpriseConnectionId,
        );
        $baseUrl = $this->sdkConfiguration->getTemplatedServerUrl();
        $url = Utils\Utils::generateUrl($baseUrl, '/enterprise_connections/{enterprise_connection_id}/test_runs', Operations\CreateEnterpriseConnectionTestRunRequest::class, $request);
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];
        $httpOptions['headers']['Accept'] = 'application/json';
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('POST', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'CreateEnterpriseConnectionTestRun', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Clerk\Backend\Models\Components\EnterpriseConnectionTestRunResponse', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new Operations\CreateEnterpriseConnectionTestRunResponse(
                    statusCode: $statusCode,
                    contentType: $contentType,
                    rawResponse: $httpResponse,
     ...
     *
     * @param  string  $enterpriseConnectionId
     * @return \Clerk\Backend\Models\Operations\DeleteEnterpriseConnectionResponse
     * @throws \Clerk\Backend\Models\Errors\SDKException
     */
     ...
     *
     * @param  string  $enterpriseConnectionId
     * @return \Clerk\Backend\Models\Operations\GetEnterpriseConnectionResponse
     * @throws \Clerk\Backend\Models\Errors\SDKException
     */
     ...
     * @param  ?int  $limit
     * @param  ?int  $offset
     * @return \Clerk\Backend\Models\Operations\ListEnterpriseConnectionTestRunsResponse
     * @throws \Clerk\Backend\Models\Errors\SDKException
     */
    public function listTestRuns(string $enterpriseConnectionId, ?array $status = null, ?int $limit = null, ?int $offset = null, ?Options $options = null): Operations\ListEnterpriseConnectionTestRunsResponse
    {
        $retryConfig = null;
        if ($options) {
            $retryConfig = $options->retryConfig;
        ...
        $request = new Operations\ListEnterpriseConnectionTestRunsRequest(
            enterpriseConnectionId: $enterpriseConnectionId,
            status: $status,
            limit: $limit,
            offset: $offset,
        ...
        $baseUrl = $this->sdkConfiguration->getTemplatedServerUrl();
        $url = Utils\Utils::generateUrl($baseUrl, '/enterprise_connections/{enterprise_connection_id}/test_runs', Operations\ListEnterpriseConnectionTestRunsRequest::class, $request);
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];

        $qp = Utils\Utils::getQueryParams(Operations\ListEnterpriseConnectionTestRunsRequest::class, $request, $urlOverride);
        $httpOptions['headers']['Accept'] = 'application/json';
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'ListEnterpriseConnectionTestRuns', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Clerk\Backend\Models\Components\EnterpriseConnectionTestRuns', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new Operations\ListEnterpriseConnectionTestRunsResponse(
                    statusCode: $statusCode,
                    contentType: $contentType,
                    rawResponse: $httpResponse,
     ...
     * @param  ?bool  $active
     * @return \Clerk\Backend\Models\Operations\ListEnterpriseConnectionsResponse
     * @throws \Clerk\Backend\Models\Errors\SDKException
     */
     ...
     *
     * @param  \Clerk\Backend\Models\Operations\UpdateEnterpriseConnectionRequestBody  $requestBody
     * @param  string  $enterpriseConnectionId
     * @return \Clerk\Backend\Models\Operations\UpdateEnterpriseConnectionResponse
     * @throws \Clerk\Backend\Models\Errors\SDKException
     */
