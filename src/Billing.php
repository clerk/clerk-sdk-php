...
class Billing
{
     ...
     * @return \Clerk\Backend\Models\Operations\ApplyBillingSubscriptionItemDiscountResponse
     * @throws \Clerk\Backend\Models\Errors\SDKException
     */
    public function applySubscriptionItemDiscount(Components\ApplyCommerceDiscountRequest $applyCommerceDiscountRequest, string $subscriptionItemId, ?Options $options = null): Operations\ApplyBillingSubscriptionItemDiscountResponse
    {
        $retryConfig = null;
        if ($options) {
        ...
        $request = new Operations\ApplyBillingSubscriptionItemDiscountRequest(
            subscriptionItemId: $subscriptionItemId,
            applyCommerceDiscountRequest: $applyCommerceDiscountRequest,
        );
        $baseUrl = $this->sdkConfiguration->getTemplatedServerUrl();
        $url = Utils\Utils::generateUrl($baseUrl, '/billing/subscription_items/{subscription_item_id}/discounts', Operations\ApplyBillingSubscriptionItemDiscountRequest::class, $request);
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, 'applyCommerceDiscountRequest', 'json');
        if ($body === null) {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'ApplyBillingSubscriptionItemDiscount', null, $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Clerk\Backend\Models\Components\CommerceDiscountRedemptionResponse', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new Operations\ApplyBillingSubscriptionItemDiscountResponse(
     ...
     * @return \Clerk\Backend\Models\Operations\RemoveBillingSubscriptionItemDiscountResponse
     * @throws \Clerk\Backend\Models\Errors\SDKException
     */
    public function removeSubscriptionItemDiscount(string $subscriptionItemId, string $discountId, ?Options $options = null): Operations\RemoveBillingSubscriptionItemDiscountResponse
    {
        $retryConfig = null;
        if ($options) {
            $retryConfig = $options->retryConfig;
        ...
        $request = new Operations\RemoveBillingSubscriptionItemDiscountRequest(
            subscriptionItemId: $subscriptionItemId,
            discountId: $discountId,
        );
        $baseUrl = $this->sdkConfiguration->getTemplatedServerUrl();
        $url = Utils\Utils::generateUrl($baseUrl, '/billing/subscription_items/{subscription_item_id}/discounts/{discount_id}', Operations\RemoveBillingSubscriptionItemDiscountRequest::class, $request);
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];
        $httpOptions['headers']['Accept'] = 'application/json';
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('DELETE', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'RemoveBillingSubscriptionItemDiscount', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Clerk\Backend\Models\Components\CommerceDiscountRedemptionResponse', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new Operations\RemoveBillingSubscriptionItemDiscountResponse(
                    statusCode: $statusCode,
                    contentType: $contentType,
                    rawResponse: $httpResponse,
                    commerceDiscountRedemptionResponse: $obj);
