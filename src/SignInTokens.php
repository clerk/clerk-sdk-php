...
class SignInTokens
{
    ...
    public function create(?Operations\CreateSignInTokenRequestBody $request = null, ?Options $options = null): Operations\CreateSignInTokenResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'CreateSignInToken', [], $this->sdkConfiguration->securitySource);
    ...
    public function revoke(string $signInTokenId, ?Options $options = null): Operations\RevokeSignInTokenResponse
    {
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('POST', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'RevokeSignInToken', [], $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
