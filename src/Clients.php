...
class Clients
{
    ...
    public function get(string $clientId, ?Options $options = null): Operations\GetClientResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'GetClient', [], $this->sdkConfiguration->securitySource);
    ...
    public function list(?bool $paginated = null, ?int $limit = null, ?int $offset = null, ?Options $options = null): Operations\GetClientListResponse
    {
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'GetClientList', [], $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
    ...
    public function verify(?Operations\VerifyClientRequestBody $request = null, ?Options $options = null): Operations\VerifyClientResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'VerifyClient', [], $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
