...
class OrganizationWithLogo
{
    /**
     *
     * @var \Clerk\Backend\Models\Components\OrganizationWithLogoObject $object
     */
    ...
    /**
     * @param  \Clerk\Backend\Models\Components\OrganizationWithLogoObject  $object
     * @param  string  $id
     * @param  string  $name
     * @param  string  $slug
