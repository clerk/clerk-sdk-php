...
class CommercePlan2
{
     ...
     *
     * @var \Clerk\Backend\Models\Components\CommercePlan2Object $object
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('object')]
    #[\Speakeasy\Serializer\Annotation\Type('\Clerk\Backend\Models\Components\CommercePlan2Object')]
    ...
    /**
     *
     * @var ?\Clerk\Backend\Models\Components\CommercePlan2Fee $fee
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('fee')]
    #[\Speakeasy\Serializer\Annotation\Type('\Clerk\Backend\Models\Components\CommercePlan2Fee|null')]
    public ?CommercePlan2Fee $fee;

    /**
     *
     * @var ?\Clerk\Backend\Models\Components\CommercePlan2AnnualMonthlyFee $annualMonthlyFee
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('annual_monthly_fee')]
    #[\Speakeasy\Serializer\Annotation\Type('\Clerk\Backend\Models\Components\CommercePlan2AnnualMonthlyFee|null')]
    public ?CommercePlan2AnnualMonthlyFee $annualMonthlyFee;

    /**
     *
     * @var ?\Clerk\Backend\Models\Components\CommercePlan2AnnualFee $annualFee
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('annual_fee')]
    #[\Speakeasy\Serializer\Annotation\Type('\Clerk\Backend\Models\Components\CommercePlan2AnnualFee|null')]
    public ?CommercePlan2AnnualFee $annualFee;
    ...
    /**
     * @param  \Clerk\Backend\Models\Components\CommercePlan2Object  $object
     * @param  string  $id
     * @param  string  $name
     * @param  int  $amount
     ...
     * @param  ?\Clerk\Backend\Models\Components\CommercePlan2Fee  $fee
     * @param  ?\Clerk\Backend\Models\Components\CommercePlan2AnnualMonthlyFee  $annualMonthlyFee
     * @param  ?\Clerk\Backend\Models\Components\CommercePlan2AnnualFee  $annualFee
     * @param  ?string  $period
     * @param  ?int  $interval
     ...
     * @phpstan-pure
     */
    public function __construct(CommercePlan2Object $object, string $id, string $name, int $amount, string $amountFormatted, int $annualMonthlyAmount, string $annualMonthlyAmountFormatted, int $annualAmount, string $annualAmountFormatted, string $currencySymbol, string $currency, string $description, string $productId, bool $isDefault, bool $isRecurring, bool $publiclyVisible, bool $hasBaseFee, array $payerType, string $forPayerType, string $slug, string $avatarUrl, array $features, ?CommercePlan2Fee $fee = null, ?CommercePlan2AnnualMonthlyFee $annualMonthlyFee = null, ?CommercePlan2AnnualFee $annualFee = null, ?string $period = null, ?int $interval = null, ?bool $freeTrialEnabled = null, ?int $freeTrialDays = null)
    {
        $this->object = $object;
        $this->id = $id;
        $this->name = $name;
