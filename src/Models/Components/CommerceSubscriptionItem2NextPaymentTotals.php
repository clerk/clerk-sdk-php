...
/** CommerceSubscriptionItem2NextPaymentTotals - Breakdown of the recurring amount that will be billed at renewal (base fee + per-unit charges). Tax and credits are not previewed. */
class CommerceSubscriptionItem2NextPaymentTotals
{
    ...
    /**
     *
     * @var ?\Clerk\Backend\Models\Components\CommerceSubscriptionItem2NextPaymentCredits $credits
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('credits')]
    #[\Speakeasy\Serializer\Annotation\Type('\Clerk\Backend\Models\Components\CommerceSubscriptionItem2NextPaymentCredits|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    public ?CommerceSubscriptionItem2NextPaymentCredits $credits = null;

    /**
     *
     * @var ?\Clerk\Backend\Models\Components\CommerceSubscriptionItem2NextPaymentDiscounts $discounts
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('discounts')]
    #[\Speakeasy\Serializer\Annotation\Type('\Clerk\Backend\Models\Components\CommerceSubscriptionItem2NextPaymentDiscounts|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    public ?CommerceSubscriptionItem2NextPaymentDiscounts $discounts = null;
     ...
     * @param  ?\Clerk\Backend\Models\Components\CommerceSubscriptionItem2NextPaymentCredits  $credits
     * @param  ?\Clerk\Backend\Models\Components\CommerceSubscriptionItem2NextPaymentDiscounts  $discounts
     * @phpstan-pure
     */
    public function __construct(CommerceMoneyResponse $subtotal, CommerceMoneyResponse $baseFee, CommerceMoneyResponse $taxTotal, CommerceMoneyResponse $grandTotal, ?array $perUnitTotals = null, ?CommerceSubscriptionItem2NextPaymentCredits $credits = null, ?CommerceSubscriptionItem2NextPaymentDiscounts $discounts = null)
    {
