...
class SchemasEnterpriseConnection
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, string $name, bool $active, array $domains, int $createdAt, int $updatedAt, ?bool $syncUserAttributes = null, ?bool $disableAdditionalIdentifications = null, ?array $customAttributes = null, ?string $organizationId = null, ?SchemasEnterpriseConnectionSamlConnection $samlConnection = null, ?OauthConfig $oauthConfig = null)
    {
        $this->id = $id;
        $this->name = $name;
        $this->active = $active;
