...
class SignUps
{
    ...
    public function get(string $id, ?Options $options = null): Operations\GetSignUpResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'GetSignUp', [], $this->sdkConfiguration->securitySource);
    ...
    public function update(string $id, ?Operations\UpdateSignUpRequestBody $requestBody = null, ?Options $options = null): Operations\UpdateSignUpResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'UpdateSignUp', [], $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
