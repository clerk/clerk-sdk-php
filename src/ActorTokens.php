...
class ActorTokens
{
    ...
    public function create(?Operations\CreateActorTokenRequestBody $request = null, ?Options $options = null): Operations\CreateActorTokenResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'CreateActorToken', [], $this->sdkConfiguration->securitySource);
    ...
    public function revoke(string $actorTokenId, ?Options $options = null): Operations\RevokeActorTokenResponse
    {
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('POST', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'RevokeActorToken', [], $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
