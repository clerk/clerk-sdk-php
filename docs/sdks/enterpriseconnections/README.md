...
if ($response->enterpriseConnection !== null) {
    // handle response
}
```
...
<!-- UsageSnippet language="php" operationID="ListEnterpriseConnectionTestRuns" method="get" path="/enterprise_connections/{enterprise_connection_id}/test_runs" -->
```php
declare(strict_types=1);
...
$response = $sdk->enterpriseConnections->listTestRuns(
    enterpriseConnectionId: '<id>',
    limit: 10,
    offset: 0
...
if ($response->enterpriseConnectionTestRuns !== null) {
    // handle response
}
```
...
**[?Operations\ListEnterpriseConnectionTestRunsResponse](../../Models/Operations/ListEnterpriseConnectionTestRunsResponse.md)**
...
<!-- UsageSnippet language="php" operationID="CreateEnterpriseConnectionTestRun" method="post" path="/enterprise_connections/{enterprise_connection_id}/test_runs" -->
```php
declare(strict_types=1);
...
$response = $sdk->enterpriseConnections->createTestRun(
    enterpriseConnectionId: '<id>'
);

if ($response->enterpriseConnectionTestRunResponse !== null) {
    // handle response
}
```
...
**[?Operations\CreateEnterpriseConnectionTestRunResponse](../../Models/Operations/CreateEnterpriseConnectionTestRunResponse.md)**
