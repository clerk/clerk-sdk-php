...
<!-- UsageSnippet language="php" operationID="ListUserBiometricCredentials" method="get" path="/users/{user_id}/biometric_credentials" -->
```php
declare(strict_types=1);
...
$response = $sdk->users->listBiometricCredentials(
    userId: '<id>'
);

if ($response->biometricCredentialList !== null) {
    // handle response
}
```
...
**[?Operations\ListUserBiometricCredentialsResponse](../../Models/Operations/ListUserBiometricCredentialsResponse.md)**
...
<!-- UsageSnippet language="php" operationID="RevokeUserBiometricCredential" method="delete" path="/users/{user_id}/biometric_credentials/{biometric_credential_id}" -->
```php
declare(strict_types=1);
...
$response = $sdk->users->revokeBiometricCredential(
    userId: '<id>',
    biometricCredentialId: '<id>'

);

if ($response->biometricCredential !== null) {
    // handle response
}
```
...
**[?Operations\RevokeUserBiometricCredentialResponse](../../Models/Operations/RevokeUserBiometricCredentialResponse.md)**
